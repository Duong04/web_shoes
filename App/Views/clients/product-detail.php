	...
	<div class="product_image_area">
		<div class="container">
			<div class="row s_product_inner">
				<div class="col-lg-6 py-5" style="box-shadow: 0 0 6px #ccc; border-radius: 8px;">
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						...
						<h2 class="mb-1">$<?=round($product['new_price'])?>.00</h2>
						<?php if ($product['discount'] > 0) { ?>
                            <div class="d-flex align-items-center" style="gap: 10px;">
                                <h5 class="text-danger mb-0">-<?=$product['discount']?>%</h5>
                                <del class="text-secondary">$<?=round($product['initial_price'])?>.00</del>
                            </div>
                        <?php } ?>
						<ul class="list">
							<li><a class="active" href="#"><span>Category</span> : <?=$product['category_name']?></a></li>
							<li><a href="#"><span>Availibility</span> : <?=$product['quantity_product'] > 0 ? 'In Stock' : 'Out Stock'?></a></li>
						</ul>
						...
						<div class="col-lg-6">
							<div class="comment_list">
								<div class="review_item">
									<div class="media">
										<div class="d-flex">
											<img src="./public/img/product/review-1.png" alt="">
										</div>
								...
								<div class="review_item reply">
									<div class="media">
										<div class="d-flex">
											<img src="./public/img/product/review-2.png" alt="">
										</div>
										<div class="media-body">
											<h4>Blake Ruiz</h4>
											<h5>12th Feb, 2018 at 05:56 pm</h5>
								...
								<div class="review_item">
									<div class="media">
										<div class="d-flex">
											<img src="./public/img/product/review-3.png" alt="">
										</div>
										<div class="media-body">
											<h4>Blake Ruiz</h4>
											<h5>12th Feb, 2018 at 05:56 pm</h5>
